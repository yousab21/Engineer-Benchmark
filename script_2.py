...
class UI:
    ...
    def welcomeScreen(self):
        utils.clear()
        utils.print_centered(f"{Fore.CYAN}"+"                 ╔═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+r"                 ║   ______ _   _  _____ _____ _   _ ______ ______ _____        ____  ______ _   _  _____ _    _ __  __          _____  _  __  ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+r"                 ║  |  ____| \ | |/ ____|_   _| \ | |  ____|  ____|  __ \      |  _ \|  ____| \ | |/ ____| |  | |  \/  |   /\   |  __ \| |/ /  ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+r"                 ║  | |__  |  \| | |  __  | | |  \| | |__  | |__  | |__) |     | |_) | |__  |  \| | |    | |__| | \  / |  /  \  | |__) | ' /   ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+r"                 ║  |  __| | . ` | | |_ | | | | . ` |  __| |  __| |  _  /      |  _ <|  __| | . ` | |    |  __  | |\/| | / /\ \ |  _  /|  <    ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+r"                 ║  | |____| |\  | |__| |_| |_| |\  | |____| |____| | \ \      | |_) | |____| |\  | |____| |  | | |  | |/ ____ \| | \ \| . \   ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+r"                 ║  |______|_| \_|\_____|_____|_| \_|______|______|_|  \_\     |____/|______|_| \_|\_____|_|  |_|_|  |_/_/    \_\_|  \_\_|\_\  ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+"                 ║                                                                                                                             ║"+f"{Style.RESET_ALL}")
        utils.print_centered(f"{Fore.CYAN}"+"                 ╚═════════════════════════════════════════════════════════ ▲ ═════════════════════════════════════════════════════════════════╝"+f"{Style.RESET_ALL}")
